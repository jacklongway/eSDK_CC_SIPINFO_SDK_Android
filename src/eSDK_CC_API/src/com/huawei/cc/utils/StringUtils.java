 ...
 */
@SuppressLint("NewApi") public class StringUtils
{
	/**
	...
	{
		WifiManager wifiManager = (WifiManager) CCApp.getInstances().getApplication().getSystemService(Context.WIFI_SERVICE);
